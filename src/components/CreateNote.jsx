...
const CreateNote = () => {
  ...
  return (
    <div className="mt-3">
      ...
      <input
        type="text"
        className="w-full px-2 py-1 border border-gray-400 rounded focus:outline-none focus:ring-4 focus:ring-blue-400 transition-all"
      ...
      <textarea
        type="text"
        className="w-full px-2 py-1 border border-gray-400 rounded focus:outline-none focus:ring-4 focus:ring-blue-400 transition-all mt-3"
        placeholder="Enter you title here:"
        name="description"
